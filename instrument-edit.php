                        ...
                        <div class="col-4">
                            ...
                            <form action="doUpdateInstrument.php" method="post" enctype="multipart/form-data">
                                <div class="bg-body border ratio ratio-1x1">
                                    <img class="object-fit-contain p-2" src="/boundless/instrument_images/<?= $row["category_name"] ?>/<?= $row["subcategory_name"] ?>/<?= $row["img"] ?>" alt="商品:<?= $row["name"] ?>" id="preview_image">
                                </div>

                                <!-- 上傳檔案 -->
                                <div class="my-2 text-center fw-bold">修改圖片</div>
                            ...
                            <table class="table table-striped-columns">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-10 border-end">
                                        <input type="datetime-local" class="form-control" style="width: 40%;" name="onshelf_time" min="<?= date("Y-m-d H:i") ?>" value="<?= date("Y-m-d H:i", strtotime($row["onshelf_time"])) ?>">
                                    </td>
                                </tr>
