                        ...
                        <div class="col-8 pe-2">
                            <table class="table table-striped-columns">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-3">
                                        <select select class="form-select d-inline-block py-0" style="width:auto;" name="brand">
                                    ...
                                    <td class="col-5 border-end">
                                        <!-- 類別 -->
                                        <select select class="form-select d-inline-block py-0" style="width:auto;" name="category">
                                        ...
                                        <select class="form-select d-inline-block py-0" style="width:auto;" name="subcategory">
                                            <?php foreach ($subcategoryRows as $subcategoryRow) : ?>
                                                <option value="<?= $subcategoryRow["id"] ?>"><?= $subcategoryRow["name"] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
