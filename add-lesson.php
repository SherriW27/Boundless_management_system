                    ...
                    <div class="mx-3 py-3 row gx-5">
                        ...
                        <div class="col-8 pe-2">
                            <table class="table table-striped-columns">
                                <tr class="row">
                                    <td class="col-2 border-start fw-bold">name</td>
                                ...
                                <tr class="row">
                                    <td class="col-2 border-start fw-bold">classroom_name</td>
                                    <td class="col-10 border-end p-1">
                                        <div class="col-sm-10">
                                ...
                                <tr class="row">
                                    <td class="col-2 border-start fw-bold">teacher_name</td>
                                    <td class="col-10 border-end p-1">
                                ...
                                <tr class="row">
                                    <td class="col-2 border-start fw-bold">info</td>
                                    <td class="col-10 border-end p-1">
