    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="instrument-list.html">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div>
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">樂器商品清單</h1>
                        <p class="mb-4 text-secondary">點選 <i class="fa-solid fa-circle-info"></i> 按鍵，查看或編輯商品詳情。</p>
                    </div>
                    <div class="card">
                                                ...
                                                <?php foreach ($rows as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="table-text-center">
                                                            <img class="object-fit-contain img-box" src="/boundless/instrument_images/<?= $row["category_name"] ?>/<?= $row["subcategory_name"] ?>/<?= $row["img"] ?>" alt="商品:<?= $row["name"] ?>">
                                                        </td>
